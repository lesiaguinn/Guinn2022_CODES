...
% r1=num(2:73,1:3:16); %WT %uncomment for TBR1
% r2=num(2:73,2:3:17); %WT
% r3=num(2:73,3:3:18); %WT

r1=num(2:73,20:3:35); %MT %uncomment for TBR1dA
r2=num(2:73,21:3:36); %MT
r3=num(2:73,22:3:37); %MT
...
xlabel('Time (hrs)'); ylabel('log(N)'); title ('TBR1\Deltaa R3');  
