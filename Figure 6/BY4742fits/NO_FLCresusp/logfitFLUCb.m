...
cave=2.887864768877966e-06;
Cave=1.829242830951401e+02;
Sin=6.079605910444325e+02;
...
%         Cdata=Nin+(Nend-Nin)*(Cdata-Nin)/(NendR-Nin);
        ...
        r = optimvar('r',8,"LowerBound",[0.03 0.01 0.1 1.0 130.0 0.25 1e-5 0.05],"UpperBound",[0.075 0.05 10.0 4.5 200.0 0.3 5e-5 0.25]);
        ...
        r0.r = [0.1 1.0 1.0 4.0 100.0 0.275 0.05e-3 0.1];
