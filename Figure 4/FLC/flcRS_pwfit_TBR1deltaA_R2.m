...
h9=plot(round(interiorbreak4ii),y4(round(interiorbreak4ii+1)),'ko','LineWidth',3,'MarkerSize',12); % 2
...
xlabel('Time (hrs)'); ylabel('log(OD_{600})'); title ('TBR1\Deltaa R2_{RESUSP.}');  
...
slopeat043=(y3(round(interiorbreak3ii+1))-y3(round(interiorbreak3+1)))/(interiorbreak3ii-interiorbreak3)
durationat043=interiorbreak3ii-interiorbreak3
 
slopeat044=(y3(end)-y3(round(interiorbreak3ii+1)))/(t(end)-interiorbreak3ii)
durationat044=t(end)-interiorbreak3ii
 
% concentration 06
slopeat061=(y4(round(interiorbreak4ii+1))-y4(1))/interiorbreak4ii
durationat061=interiorbreak4ii
 
slopeat062=(y4(end)-y4(round(interiorbreak4ii+1)))/(t(end)-interiorbreak4ii)
durationat062=t(end)-interiorbreak4ii
...
slopeat083=(y5(round(interiorbreak5ii+1))-y5(round(interiorbreak5+1)))/(interiorbreak5ii-interiorbreak5)
durationat083=interiorbreak5ii-interiorbreak5
...
Y = [0 0 interiorbreak1;
    ...
    interiorbreak5i interiorbreak5 interiorbreak5ii;
