...
cave=6.090501606801946e-06;
Cave=26.294855965617558;
Sin=5.855712053958924e+02;
...
%         Cdata=Nin+(Nend-Nin)*(Cdata-Nin)/(NendR-Nin);
        ...
        r = optimvar('r',8,"LowerBound",[0.5 0.01 1.5 0.025 100.0 0.25 5e-6 0.005],"UpperBound",[2.0 0.05 5.5 0.05 250.0 0.3 5e-5 0.01]);
