...
t4ii=t(interiorbreak4i:(interiorbreak4-12));
y4ii=y4(interiorbreak4i:(interiorbreak4-12));
dt = max(t4ii) - min(t4ii);
[interiorbreak4ii,fval4ii] = fminbnd(@(b2) breakfit(b2,t4ii,y4ii),min(t4ii) + dt/100,max(t4ii) - dt/100);
interiorbreak4ii
 
t4iii=t(interiorbreak4ii:interiorbreak4);
y4iii=y4(interiorbreak4ii:interiorbreak4);
...
y5ii=y4(interiorbreak5i:interiorbreak5);
dt = max(t5ii) - min(t5ii);
[interiorbreak5ii,fval5ii] = fminbnd(@(b2) breakfit(b2,t5ii,y5ii),min(t5ii) + dt/100,max(t5ii) - dt/100);
interiorbreak5ii
 
t5iii=t((interiorbreak5ii+12):interiorbreak5);
y5iii=y4((interiorbreak5ii+12):interiorbreak5);
...
h6=plot(round(interiorbreak2ii),y2(round(interiorbreak2ii+1)),'ko','LineWidth',3,'MarkerSize',12);
 
h7=plot(t,y3,'color',[0.4 0.75 0.6],'LineWidth',3); hold on;
h8=plot(round(interiorbreak3i),y3(round(interiorbreak3i+1)),'ko','LineWidth',3,'MarkerSize',12); 
h9=plot(round(interiorbreak3ii),y3(round(interiorbreak3ii+1)),'ko','LineWidth',3,'MarkerSize',12);
h10=plot(round(interiorbreak3iii),y3(round(interiorbreak3iii+1)),'ko','LineWidth',3,'MarkerSize',12);
 
h11=plot(t,y4,'color',[0.3 0.5 0.4],'LineWidth',3); hold on;
h12=plot(round(interiorbreak4),y4(round(interiorbreak4+1)),'ko','LineWidth',3,'MarkerSize',12);
% plot(round(interiorbreak4i),y4(round(interiorbreak4i+1)),'ko','LineWidth',3,'MarkerSize',12);
h13=plot(round(interiorbreak4ii),y4(round(interiorbreak4ii+1)),'ko','LineWidth',3,'MarkerSize',12);
h14=plot(round(interiorbreak4iii),y4(round(interiorbreak4iii+1)),'ko','LineWidth',3,'MarkerSize',12);
...
h18=plot(round(interiorbreak5iii),y5(round(interiorbreak5iii+1)),'ko','LineWidth',3,'MarkerSize',12);
 
h19=plot(t,y6,'color',[0.1 0.0 0.2],'LineWidth',3); hold on;
h20=plot(round(interiorbreak6i),y6(round(interiorbreak6i+1)),'ko','LineWidth',3,'MarkerSize',12);
...
xlabel('Time (hrs)'); ylabel('log(OD_{600})'); title ('TBR1 R1_{RESUSP.}');  
...
slopeat022=(y2(round(interiorbreak2ii+1))-y2(round(interiorbreak2+1)))/(interiorbreak2ii-interiorbreak2)
durationat022=interiorbreak2ii-interiorbreak2
...
% concentration 06
slopeat061=(y4(round(interiorbreak4ii+1))-y4(1))/interiorbreak4ii
durationat061=interiorbreak4ii
 
slopeat062=(y4(round(interiorbreak4iii+1))-y4(round(interiorbreak4ii+1)))/(interiorbreak4iii-interiorbreak4ii)
durationat062=interiorbreak4iii-interiorbreak4ii
 
slopeat063=(y4(round(interiorbreak4+1))-y4(round(interiorbreak4iii+1)))/(interiorbreak4-interiorbreak4iii)
durationat063=interiorbreak4-interiorbreak4iii
...
slopeat083=(y5(round(interiorbreak5iii+1))-y5(round(interiorbreak5ii+1)))/(interiorbreak5iii-interiorbreak5ii)
durationat083=interiorbreak5iii-interiorbreak5ii
 
slopeat084=(y5(end)-y5(round(interiorbreak5iii+1)))/(t(end)-interiorbreak5iii)
durationat084=t(end)-interiorbreak5iii
...
dur2 = [0 durationat022 durationat042 durationat062 durationat082 0];
...
dur2 = [0 durationat023 durationat043 durationat063 durationat083 0];
...
dur2 = [durationat002 durationat024 durationat044 durationat064 durationat084 durationat102];
...
dur6 = [0 slopeat022 slopeat042 slopeat062 slopeat082 0];
...
dur7 = [0 slopeat023 slopeat043 slopeat063 slopeat083 0];
...
dur8 = [slopeat002 slopeat024 slopeat044 slopeat064 slopeat084 slopeat102];
...
Y = [0 0 interiorbreak1;
    interiorbreak2 interiorbreak2ii interiorbreak2i;
    interiorbreak3ii interiorbreak3i interiorbreak3iii;
    interiorbreak4ii interiorbreak4iii interiorbreak4;
    interiorbreak5 interiorbreak5ii interiorbreak5iii;
    0 0 interiorbreak6i];
