...
cave=2.760598237973559e-06;
Cave=1.623775010939632e+02;
Sin=4.785556069035827e+02;
...
%         Cdata=Nin+(Nend-Nin)*(Cdata-Nin)/(NendR-Nin);
        ...
        r = optimvar('r',8,"LowerBound",[0.01 0.005 2.5 1.2 100.0 0.2 1e-6 1e-6],"UpperBound",[0.1 0.02 50.0 5.5 250.0 0.25 1e-5 1e-5]); %new
        ...
        r0.r = [0.4 1.0 1.0 4.0 100.0 0.5 0.05e-4 0.0];
