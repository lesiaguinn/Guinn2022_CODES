...
plot(round(interiorbreak5),y3(round(interiorbreak5+1)),'ko','LineWidth',3,'MarkerSize',12);
set(gca,'FontSize',24,'LineWidth',3,'fontname','arial','xcolor','k','ycolor','k');pbaspect([1 1 1]);box on;ylim([-2 1]);xlim([-5 77]);
xlabel('Time (hrs)');ylabel('log(OD_{600})');
...
tnew3=t(interiorbreak11:interiorbreak10);
ynew3=y6(interiorbreak11:interiorbreak10);
...
plot(round(interiorbreak13),y6(round(interiorbreak13+1)),'ko','LineWidth',3,'MarkerSize',12);
set(gca,'FontSize',24,'LineWidth',3,'fontname','arial','xcolor','k','ycolor','k'); pbaspect([1 1 1]); box on; ylim([-2 1]); xlim([-5 77]);
xlabel('Time (hrs)'); ylabel('log(OD_{600})');
...
h8=plot(round(interiorbreak5),y3(round(interiorbreak5+1)),'ko','LineWidth',3,'MarkerSize',12); %% 1
...
h18=plot(round(interiorbreak13),y6(round(interiorbreak13+1)),'ko','LineWidth',3,'MarkerSize',12); %% 1
...
% concentration 04
slopeat041=(y3(round(interiorbreak5+1))-y3(1))/interiorbreak5
durationat041=interiorbreak5
 
slopeat043=(y3(end)-y3(round(interiorbreak5+1)))/(t(end)-interiorbreak5)
durationat043=t(end)-interiorbreak5
...
% concentration 10
slopeat101=(y6(round(interiorbreak13+1))-y6(1))/interiorbreak13
durationat101=interiorbreak13
 
slopeat102=(y6(end)-y6(round(interiorbreak13+1)))/(t(end)-interiorbreak13)
durationat102=t(end)-interiorbreak13
