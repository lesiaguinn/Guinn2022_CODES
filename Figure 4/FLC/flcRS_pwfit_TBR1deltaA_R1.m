...
xlabel('Time (hrs)'); ylabel('log(OD_{600})'); title ('TBR1\Deltaa R1_{RESUSP.}');  
...
slopeat022=(y2(end)-y2(round(interiorbreak2i+1)))/(t(end)-interiorbreak2i)
durationat022=t(end)-interiorbreak2i
...
pbaspect([2 1 1]); ylabel('D1 (hrs)'); %xlim([-0.2 1.2]);
...
hb2.CData(1,:) = [1.0 1.0 0.6];
hb2.CData(2,:) = [1.0 1.0 0.2];
hb2.CData(3,:) = [1.0 0.8 0.2];
hb2.CData(4,:) = [1.0 0.4 0.2];
hb2.CData(5,:) = [0.7 0.2 0.0];
hb2.CData(6,:) = [0.6 0.0 0.0];
 
set(gca,'FontSize',24,'LineWidth',3,'fontname','arial','xcolor','k','ycolor','k');
pbaspect([2 1 1]); ylabel('D2 (hrs)'); %xlim([-0.2 1.2]);
...
E = [0 0.2 0.4 0.6 0.8 1];
dur3 = [slopeat001 slopeat021 slopeat041 slopeat061 slopeat081 slopeat101];
 
hb3 = bar(E,dur3,'FaceColor','flat','EdgeColor','k','LineWidth',3);
 
hb3.CData(1,:) = [1.0 1.0 0.6];
hb3.CData(2,:) = [1.0 1.0 0.2];
hb3.CData(3,:) = [1.0 0.8 0.2];
hb3.CData(4,:) = [1.0 0.4 0.2];
hb3.CData(5,:) = [0.7 0.2 0.0];
hb3.CData(6,:) = [0.6 0.0 0.0];
 
set(gca,'FontSize',24,'LineWidth',3,'fontname','arial','xcolor','k','ycolor','k');
pbaspect([2 1 1]); ylabel('S1');%xlim([-0.2 1.2]);
...
E = [0 0.2 0.4 0.6 0.8 1];
dur4 = [slopeat002 slopeat022 slopeat042 slopeat062 slopeat082 slopeat102];
 
hb4 = bar(E,dur4,'FaceColor','flat','EdgeColor','k','LineWidth',3);
 
hb4.CData(1,:) = [1.0 1.0 0.6];
...
set(gca,'FontSize',24,'LineWidth',3,'fontname','arial','xcolor','k','ycolor','k');
pbaspect([2 1 1]);  ylabel('S2');%xlim([-0.2 1.2]);
...
ba=bar(E,Y,'FaceColor',[1.0 0.8 0.2],'LineWidth',3);
...
%  
% ba(1).FaceColor = [0.3 0.3 0.3];
% ba(2).FaceColor = [0.6 0.6 0.6];
% ba(3).FaceColor = [0.9 0.9 0.9];
 
set(gca,'FontSize',24,'LineWidth',3,'fontname','arial','xcolor','k','ycolor','k','XTickLabel',{'0','50','75','0.6','0.8','1'}); box on;
legend('B1','Location','northeastoutside','EdgeColor','none'); ylabel('Break Time (hrs)'); ylim([0 10]);
pbaspect([1 1 1]);
