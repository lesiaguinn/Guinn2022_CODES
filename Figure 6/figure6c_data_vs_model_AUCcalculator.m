...
% Follow the statements in bold 

clearvars; close all;

%model data points
[num,txt,raw]=xlsread('DecFits_export_fitdata','h2o2_fitdata'); %apply for h2o2
% [num,txt,raw]=xlsread('DecFits_export_fitdata','amB_fitdata'); %apply for amB
% [num,txt,raw]=xlsread('DecFits_export_fitdata','casp_fitdata'); %apply for casp
% [num,txt,raw]=xlsread('DecFits_export_fitdata','flc_fitdata'); %apply for flc

%experimental data points
[num1,txt1,raw1]=xlsread('DecFits_export_fitdata','h2o2_cellNdata'); %apply for h2
% [num1,txt1,raw1]=xlsread('DecFits_export_fitdata','amB_cellNdata'); %apply for amB
% [num1,txt1,raw1]=xlsread('DecFits_export_fitdata','casp_cellNdata'); %apply for casp
% [num1,txt1,raw1]=xlsread('DecFits_export_fitdata','flc_cellNdata'); %apply for flc
...
% d1=num1(2:73,17:3:29); %MT
% d2=num1(2:73,18:3:30); %MT
% d3=num1(2:73,19:3:31); %MT
...
title ('TBR1 R1'); %change replicate # HERE
% title ('TBR1\Deltaa R1'); %change replicate # HERE
