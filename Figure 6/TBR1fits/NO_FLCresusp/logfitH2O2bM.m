...
cave=5.905627039469100e-06;
Cave=25.982291204003726;
Sin=476.8664789292775;
...
for d=2:length(Stress)
    ...
    for n=1:3   % 3 replicates
        ...
        r = optimvar('r',7,"LowerBound",[0.0075 1.25 4.0 0.015 2.5 1.0 0.3],"UpperBound",[0.075 2.5 15.0 0.03 3.5 1.1 1.0]);
