...
t6i=t(3:(interiorbreak6-24));
y6i=y6(3:(interiorbreak6-24));
dt = max(t6i) - min(t6i);
[interiorbreak6i,fval6i] = fminbnd(@(b2) breakfit(b2,t6i,y6i),min(t6i) + dt/100,max(t6i) - dt/100);
interiorbreak6i
 
t6vi=t(2:(interiorbreak6i-1));
y6vi=y6(2:(interiorbreak6i-1));
...
h11=plot(round(interiorbreak4ii),y4(round(interiorbreak4ii+1)),'ko','LineWidth',3,'MarkerSize',12); % 1
h12=plot(round(interiorbreak4iv),y4(round(interiorbreak4iv+1)),'ko','LineWidth',3,'MarkerSize',12); % 2
h13=plot(round(interiorbreak4),y4(round(interiorbreak4+1)),'ko','LineWidth',3,'MarkerSize',12); % 3
...
xlabel('Time (hrs)'); ylabel('log(OD_{600})'); title ('TBR1\Deltaa R2');
...
slopeat104=(y6(round(interiorbreak6v+1))-y6(round(interiorbreak6i+1)))/(interiorbreak6v-interiorbreak6i)
durationat104=interiorbreak6v-interiorbreak6i
