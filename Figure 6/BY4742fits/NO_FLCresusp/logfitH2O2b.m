...
cave=3.119734145898718e-06;
Cave=1.762138835820973e+02;
Sin=5.824824199004985e+02;
...
%         Cdata=Nin+(Nend-Nin)*(Cdata-Nin)/(NendR-Nin);
        ...
        r = optimvar('r',7,"LowerBound",[0.00025 0.02 1.0 0.3 45.0 0.3 0.5],"UpperBound",[0.0005 0.04 5.0 0.55 50.0 0.5 1.5]);
        ...
        r0.r = [0.004 8.0 4.0 0.75 1.5 0.4 1.0];
