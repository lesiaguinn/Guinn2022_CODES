...
t2i=t(2:interiorbreak2);
y2i=y2(2:interiorbreak2);
dt = max(t2i) - min(t2i);
[interiorbreak2i,fval2i] = fminbnd(@(b2) breakfit(b2,t2i,y2i),min(t2i) + dt/100,max(t2i) - dt/100);
interiorbreak2i
 
t2iv=t(interiorbreak2i:end);
y2iv=y2(interiorbreak2i:end);
dt = max(t2iv) - min(t2iv);
[interiorbreak2iv,fval2iv] = fminbnd(@(b2) breakfit(b2,t2iv,y2iv),min(t2iv) + dt/100,max(t2iv) - dt/100);
interiorbreak2iv
 
figure(3);
plot(t,y2,'LineWidth',3); hold on;
plot(round(interiorbreak2iv),y2(round(interiorbreak2iv+1)),'ko','LineWidth',3,'MarkerSize',12);
set(gca,'FontSize',24,'LineWidth',3,'fontname','arial','xcolor','k','ycolor','k');pbaspect([1 1 1]);box on;ylim([-2 1]);xlim([-5 77]);
xlabel('Time (hrs)');ylabel('log(OD_{600})');
 
t2ii=t(1:interiorbreak2i);
y2ii=y2(1:interiorbreak2i);
dt = max(t2ii) - min(t2ii);
[interiorbreak2ii,fval2ii] = fminbnd(@(b2) breakfit(b2,t2ii,y2ii),min(t2ii) + dt/100,max(t2ii) - dt/100);
interiorbreak2ii
 
t2iii=t(1:interiorbreak2ii);
y2iii=y2(1:interiorbreak2ii);
...
t6ii=t(1:interiorbreak6i);
y6ii=y6(1:interiorbreak6i);
...
t6iii=t(interiorbreak6:end);
y6iii=y6(interiorbreak6:end);
dt = max(t6iii) - min(t6iii);
[interiorbreak6iii,fval6iii] = fminbnd(@(b2) breakfit(b2,t6iii,y6iii),min(t6iii) + dt/100,max(t6iii) - dt/100);
interiorbreak6iii
 
t6iv=t(interiorbreak6:interiorbreak6iii);
y6iv=y6(interiorbreak6:interiorbreak6iii);
...
t6v=t(interiorbreak6iii:end);
y6v=y6(interiorbreak6iii:end);
dt = max(t6v) - min(t6v);
[interiorbreak6v,fval6v] = fminbnd(@(b2) breakfit(b2,t6v,y6v),min(t6v) + dt/100,max(t6v) - dt/100);
interiorbreak6v
 
t6vi=t(interiorbreak6iii:interiorbreak6v);
y6vi=y6(interiorbreak6iii:interiorbreak6v);
dt = max(t6vi) - min(t6vi);
[interiorbreak6vi,fval6vi] = fminbnd(@(b2) breakfit(b2,t6vi,y6vi),min(t6vi) + dt/100,max(t6vi) - dt/100);
interiorbreak6vi
 
t6vii=t(interiorbreak6iv:interiorbreak6vi);
y6vii=y6(interiorbreak6iv:interiorbreak6vi);
dt = max(t6vii) - min(t6vii);
[interiorbreak6vii,fval6vii] = fminbnd(@(b2) breakfit(b2,t6vii,y6vii),min(t6vii) + dt/100,max(t6vii) - dt/100);
interiorbreak6vii
 
figure(18);
plot(t,y6,'LineWidth',3); hold on;
plot(round(interiorbreak6vii),y6(round(interiorbreak6vii+1)),'ko','LineWidth',3,'MarkerSize',12);
set(gca,'FontSize',24,'LineWidth',3,'fontname','arial','xcolor','k','ycolor','k');pbaspect([1 1 1]);box on;ylim([-2 1]);xlim([-5 77]);
xlabel('Time (hrs)');ylabel('log(OD_{600})');
 
t6viii=t(1:interiorbreak6ii);
y6viii=y6(1:interiorbreak6ii);
dt = max(t6viii) - min(t6viii);
[interiorbreak6viii,fval6viii] = fminbnd(@(b2) breakfit(b2,t6viii,y6viii),min(t6viii) + dt/100,max(t6viii) - dt/100);
interiorbreak6viii
 
figure(19);
plot(t,y6,'LineWidth',3); hold on;
plot(round(interiorbreak6viii),y6(round(interiorbreak6viii+1)),'ko','LineWidth',3,'MarkerSize',12);
set(gca,'FontSize',24,'LineWidth',3,'fontname','arial','xcolor','k','ycolor','k');pbaspect([1 1 1]);box on;ylim([-2 1]);xlim([-5 77]);
xlabel('Time (hrs)');ylabel('log(OD_{600})');
...
h5=plot(round(interiorbreak2iii),y2(round(interiorbreak2iii+1)),'ko','LineWidth',3,'MarkerSize',12); % 1
h6=plot(round(interiorbreak2iv),y2(round(interiorbreak2iv+1)),'ko','LineWidth',3,'MarkerSize',12); % 2
...
plot(round(interiorbreak4v),y4(round(interiorbreak4v+1)),'ko','LineWidth',3,'MarkerSize',12); % 1
h11=plot(round(interiorbreak4ii),y4(round(interiorbreak4ii+1)),'ko','LineWidth',3,'MarkerSize',12); % 2
h12=plot(round(interiorbreak4iv),y4(round(interiorbreak4iv+1)),'ko','LineWidth',3,'MarkerSize',12); % 3
h13=plot(round(interiorbreak4),y4(round(interiorbreak4+1)),'ko','LineWidth',3,'MarkerSize',12); % 4
 
h14=plot(t,y5,'color',[0.7 0.2 0.0],'LineWidth',3); hold on;
h15=plot(round(interiorbreak19i),y5(round(interiorbreak19i+1)),'ko','LineWidth',3,'MarkerSize',12); % 1
h16=plot(round(interiorbreak18),y5(round(interiorbreak18+1)),'ko','LineWidth',3,'MarkerSize',12); % 2
h17=plot(round(interiorbreak19),y5(round(interiorbreak19+1)),'ko','LineWidth',3,'MarkerSize',12); % 3
h18=plot(round(interiorbreak19ii),y5(round(interiorbreak19ii+1)),'ko','LineWidth',3,'MarkerSize',12); % 4
 
h19=plot(t,y6,'color',[0.6 0.0 0.0],'LineWidth',3); hold on;
h20=plot(round(interiorbreak6iv),y6(round(interiorbreak6iv+1)),'ko','LineWidth',3,'MarkerSize',12); % 1
h21=plot(round(interiorbreak6iii),y6(round(interiorbreak6iii+1)),'ko','LineWidth',3,'MarkerSize',12); % 2
h22=plot(round(interiorbreak6i),y6(round(interiorbreak6i+1)),'ko','LineWidth',3,'MarkerSize',12); % 3
h23=plot(round(interiorbreak6ii),y6(round(interiorbreak6ii+1)),'ko','LineWidth',3,'MarkerSize',12); % 4
...
legend([h1 h4 h7 h10 h14 h19],{'0','0.2','0.4','0.6','0.8','1 \mug/ml AmB'},'Location','northeastoutside','EdgeColor','none');
...
slopeat022=(y2(round(interiorbreak2iv+1))-y2(round(interiorbreak2iii+1)))/(interiorbreak2iv-interiorbreak2iii)
durationat022=interiorbreak2iv-interiorbreak2iii
 
slopeat023=(y2(end)-y2(round(interiorbreak2iv+1)))/(t(end)-interiorbreak2iv)
durationat023=t(end)-interiorbreak2iv
% %  
% % % concentration 04
...
% %  
% % % concentration 10
slopeat101=(y6(round(interiorbreak6viii+1))-y6(1))/interiorbreak6viii
durationat101=interiorbreak6viii
 
slopeat102=(y6(round(interiorbreak6ii+1))-y6(round(interiorbreak6viii+1)))/(interiorbreak6ii-interiorbreak6viii)
durationat102=interiorbreak6ii-interiorbreak6viii
 
slopeat103=(y6(round(interiorbreak6iv+1))-y6(round(interiorbreak6ii+1)))/(interiorbreak6iv-interiorbreak6ii)
durationat103=interiorbreak6iv-interiorbreak6ii
 
slopeat104=(y6(round(interiorbreak6vii+1))-y6(round(interiorbreak6iv+1)))/(interiorbreak6vii-interiorbreak6iv)
durationat104=interiorbreak6vii-interiorbreak6iv
 
slopeat105=(y6(end)-y6(round(interiorbreak6vii+1)))/(t(end)-interiorbreak6vii)
durationat105=t(end)-interiorbreak6vii
%  
slopeat001
slopeat002
slopeat003
...
Y = [interiorbreak1ii,0,0,interiorbreak1
    interiorbreak2iii,0,0,interiorbreak2iv
    ...
    interiorbreak6viii,interiorbreak6ii,interiorbreak6iv,interiorbreak6vii];
