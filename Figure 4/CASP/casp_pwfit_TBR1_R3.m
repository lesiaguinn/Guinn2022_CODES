...
plot(round(interiorbreak2ii),y2(round(interiorbreak2ii+1)),'ko','LineWidth',3,'MarkerSize',12); % 2
...
plot(round(interiorbreak3),y3(round(interiorbreak3+1)),'ko','LineWidth',3,'MarkerSize',12); % 2 
...
h13=plot(round(interiorbreak5i),y5(round(interiorbreak5i+1)),'ko','LineWidth',3,'MarkerSize',12); % 1
h14=plot(round(interiorbreak5),y5(round(interiorbreak5+1)),'ko','LineWidth',3,'MarkerSize',12); % 2
...
h17=plot(round(interiorbreak6i),y6(round(interiorbreak6i+1)),'ko','LineWidth',3,'MarkerSize',12); % 1
h18=plot(round(interiorbreak6),y6(round(interiorbreak6+1)),'ko','LineWidth',3,'MarkerSize',12); % 2
...
E = [0 0.2 0.4 0.6 0.8 1];
mean1 = [durationat002 durationat022 durationat042 durationat062 durationat082 durationat102];
 
hb2 = bar(E,mean1,'FaceColor','flat','EdgeColor','k','LineWidth',3);
...
c5 = categorical({'a','b','c','d','e','f'});
meanslope = [0.166033333 0.032866667 0.024833333 0.0186 0.018666667 0.016966667];
 
errhigh5 = [0.008974594 0.022150922 0.005713434 0.000818535 0.001450287 0.001921805];
errlow5 = [0.008974594  0.022150922 0.005713434 0.000818535 0.001450287 0.001921805];
 
bar(c5,meanslope);
 
hb5 = bar(meanslope);
 
set(hb5,'FaceColor','flat','EdgeColor','k','LineWidth',3);
set(gca,'FontSize',24,'LineWidth',3,'fontname','arial','xcolor','k',...
   'ycolor','k','XTickLabel',{'0','0.2','0.4','0.6','0.8','1'});
ylabel('Mean S2'); 
pbaspect([2 1 1]); box on;
xtickangle(45);
...
er = errorbar(c5,meanslope,errlow5,errhigh5,'k.','Linewidth',3);    
er.Color = [0 0 0];                            
er.LineStyle = 'none';
