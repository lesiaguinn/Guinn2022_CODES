...
t1i=t(2:(interiorbreak1-6));
y1i=y1(2:(interiorbreak1-6));
dt = max(t1i) - min(t1i);
...
t2m=t(1:interiorbreak2i);
y2m=y2(1:interiorbreak2i);
dt = max(t2m) - min(t2m);
[interiorbreak2m,fval2m] = fminbnd(@(b2) breakfit(b2,t2m,y2m),min(t2m) + dt/100,max(t2m) - dt/100);
interiorbreak2m
 
figure(4);
plot(t,y2,'LineWidth',3); hold on;
plot(round(interiorbreak2m),y2(round(interiorbreak2m+1)),'ko','LineWidth',3,'MarkerSize',12);
set(gca,'FontSize',24,'LineWidth',3,'fontname','arial','xcolor','k','ycolor','k');pbaspect([1 1 1]);box on;ylim([-2 1]);xlim([-5 77]);
xlabel('Time (hrs)');ylabel('log(OD_{600})');
...
t6iii=t(1:(interiorbreak6ii-2));
y6iii=y6(1:(interiorbreak6ii-2));
...
h5=plot(round(interiorbreak2m),y2(round(interiorbreak2m+1)),'ko','LineWidth',3,'MarkerSize',12); % 1
...
h21=plot(round(interiorbreak6iii),y6(round(interiorbreak6iii+1)),'ko','LineWidth',3,'MarkerSize',12); % 1
h22=plot(round(interiorbreak6ii),y6(round(interiorbreak6ii+1)),'ko','LineWidth',3,'MarkerSize',12); % 2
h23=plot(round(interiorbreak6i),y6(round(interiorbreak6i+1)),'ko','LineWidth',3,'MarkerSize',12); % 3
h24=plot(round(interiorbreak6),y6(round(interiorbreak6+1)),'ko','LineWidth',3,'MarkerSize',12); % 4
...
% % concentration 02
slopeat021=(y2(round(interiorbreak2m+1))-y2(1))/interiorbreak2m
durationat021=interiorbreak2m
 
slopeat022=(y2(round(interiorbreak2+1))-y2(round(interiorbreak2m+1)))/(interiorbreak2-interiorbreak2m)
durationat022=interiorbreak2-interiorbreak2m
...
% %  
% % % concentration 10
slopeat101=(y6(round(interiorbreak6iii+1))-y6(1))/interiorbreak6iii
durationat101=interiorbreak6iii
 
slopeat102=(y6(round(interiorbreak6ii+1))-y6(round(interiorbreak6iii+1)))/(interiorbreak6ii-interiorbreak6iii)
durationat102=interiorbreak6ii-interiorbreak6iii
 
slopeat103=(y6(round(interiorbreak6i+1))-y6(round(interiorbreak6ii+1)))/(interiorbreak6i-interiorbreak6ii)
durationat103=interiorbreak6i-interiorbreak6ii
 
slopeat104=(y6(round(interiorbreak6+1))-y6(round(interiorbreak6i+1)))/(interiorbreak6-interiorbreak6i)
durationat104=interiorbreak6-interiorbreak6i
 
slopeat105=(y6(end)-y6(round(interiorbreak6+1)))/(t(end)-interiorbreak6)
durationat105=t(end)-interiorbreak6
%  
slopeat001
slopeat002
slopeat003
...
Y = [interiorbreak1i,0,0,interiorbreak1
    interiorbreak2m,0,0,interiorbreak2
    ...
    interiorbreak6iii,interiorbreak6ii,interiorbreak6i,interiorbreak6];
