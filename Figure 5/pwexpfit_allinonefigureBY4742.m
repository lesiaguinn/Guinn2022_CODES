...
[num,txt,raw]=xlsread('Lesia2020_BY4742.xlsx','by4742replicates_flc'); 
...
h1=plot(t,y1,'color',[ 0.6 0.2 1.0],'LineWidth',3); hold on;
h2=plot(round(interiorbreak1),y1(round(interiorbreak1+1)),'ko','LineWidth',3,'MarkerSize',12); % 1
 
h3=plot(t,y2,'color',[ 0.55 0.1 0.75],'LineWidth',3); hold on;
h4=plot(round(interiorbreak2),y2(round(interiorbreak2+1)),'ko','LineWidth',3,'MarkerSize',12); % 1
 
h7=plot(t,y3,'color',[ 0.5 0.0 0.6],'LineWidth',3); hold on;
h9=plot(round(interiorbreak3),y3(round(interiorbreak3+1)),'ko','LineWidth',3,'MarkerSize',12);
 
h11=plot(t,y4,'color',[ 0.35 0.0 0.45],'LineWidth',3); hold on;
plot(round(interiorbreak4),y4(round(interiorbreak4+1)),'ko','LineWidth',3,'MarkerSize',12);
 
h15=plot(t,y5,'color',[ 0.25 0.0 0.3],'LineWidth',3); hold on;
h17=plot(round(interiorbreak5),y5(round(interiorbreak5+1)),'ko','LineWidth',3,'MarkerSize',12);
 
h19=plot(t,y6,'color',[ 0.15 0.0 0.15],'LineWidth',3); hold on;
h20=plot(round(interiorbreak6),y6(round(interiorbreak6+1)),'ko','LineWidth',3,'MarkerSize',12);
 
set(gca,'color',[0.8 0.8 0.8],'FontSize',24,'FontName','Arial','LineWidth',3,'xcolor','k','ycolor','k');
pbaspect([1 1 1]); box on; ylim([-2 1]);xlim([-4 77]);
xlabel('Time (hrs)'); ylabel('log(OD_{600})'); title ('BY4742 R3');  
...
% subplot(2,2,1);
hold on
Y = [durationat001 durationat002;
    durationat021 durationat022;
    durationat041 durationat042;
    durationat061 durationat062;
    durationat081 durationat082;
    durationat101 durationat102];
...
ba(1).CData = [0.8 0.4 1.0];
ba(2).CData = [0.5 0.0 0.5];
 
set(gca,'FontSize',24,'LineWidth',3,'fontname','arial','xcolor','k','ycolor','k','XTickLabel',{'0','50','75','100','125','150'}); box on;
legend('B1','B2','Location','northeastoutside','EdgeColor','none'); ylabel('Break Time (hrs)'); ylim([0 80]);
pbaspect([1 1 1]);
