...
t4iii=t(interiorbreak4i:interiorbreak4);
y4iii=y4(interiorbreak4i:interiorbreak4);
...
h4=plot(round(interiorbreak2),y2(round(interiorbreak2+1)),'ko','LineWidth',3,'MarkerSize',12);
...
h10=plot(round(interiorbreak4i),y4(round(interiorbreak4i+1)),'ko','LineWidth',3,'MarkerSize',12);
...
h18=plot(round(interiorbreak6ii),y6(round(interiorbreak6ii+1)),'ko','LineWidth',3,'MarkerSize',12);
...
xlabel('Time (hrs)'); ylabel('log(OD_{600})'); title ('TBR1 R3_{RESUSP.}');  
legend([h1 h3 h5 h9 h13 h17],{'0','50','75','100','125','150 \mug/ml FLC'},'Location','northeastoutside','EdgeColor','none');
...
slopeat062=(y4(round(interiorbreak4i+1))-y4(round(interiorbreak4ii+1)))/(interiorbreak4i-interiorbreak4ii)
durationat062=interiorbreak4i-interiorbreak4ii
 
slopeat063=(y4(round(interiorbreak4iii+1))-y4(round(interiorbreak4i+1)))/(interiorbreak4iii-interiorbreak4i)
durationat063=interiorbreak4iii-interiorbreak4i
 
slopeat064=(y4(end)-y4(round(interiorbreak4iii+1)))/(t(end)-interiorbreak4iii)
durationat064=t(end)-interiorbreak4iii
...
dur2 = [0 0 durationat042 durationat062 durationat082 0];
...
dur2 = [0 0 durationat043 durationat063 durationat083 0];
...
dur2 = [durationat002 durationat022 durationat044 durationat064 durationat084 durationat102];
...
dur6 = [0 0 slopeat042 slopeat062 slopeat082 0];
...
dur7 = [0 0 slopeat043 slopeat063 slopeat083 0];
...
dur8 = [slopeat002 slopeat022 slopeat044 slopeat064 slopeat084 slopeat102];
