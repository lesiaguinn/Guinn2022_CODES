...
cave=4.350032986004960e-06;
Cave=27.474154807413569;
Sin=474.5765998314305;
...
for d=2:length(Stress)
    ...
    for n=1:3   % 3 replicates
        ...
        r = optimvar('r',7,"LowerBound",[0.0001 0.005 3.0 2.0 0.3 0.01 1.0],"UpperBound",[0.001 0.01 5.5 2.5 0.8 0.015 2.0]);
